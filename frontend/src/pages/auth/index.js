...
const Index = () => {
  ...
  <div className="hero_area">
    ...
    <img src={heroBgImage} alt="Descripción de la imagen" className="box-img" />
    </div>
        ...
        <nav className="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav  mx-auto ">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/CrearCuenta">Registrate</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="book.html">Book Table</Link>
              </li>
            </ul>
        ...
        <div className="row grid">
          <div className="col-sm-6 col-lg-4 all pizza">
            <div className="box">
              <div>
                ...
                <img src={f1} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div className="col-sm-6 col-lg-4 all burger">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f2} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Delicious Burger
          ...
          <div className="col-sm-6 col-lg-4 all pizza">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f3} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div className="col-sm-6 col-lg-4 all pasta">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f4} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Delicious Pasta
          ...
          <div className="col-sm-6 col-lg-4 all fries">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f5} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    French Fries
          ...
          <div className="col-sm-6 col-lg-4 all pizza">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f6} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div className="col-sm-6 col-lg-4 all burger">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f7} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div className="col-sm-6 col-lg-4 all burger">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f8} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div className="col-sm-6 col-lg-4 all pasta">
            <div className="box">
              <div>
                <div className="img-box">
                <img src={f9} alt="Descripción de la imagen" className="box-img" />
                </div>
                <div className="detail-box">
                  <h5>
                    Delicious Pasta
